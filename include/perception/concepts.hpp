/**
 * @file concepts.hpp
 * @brief Modern C++20/23 concepts for perception system
 * 
 * This header defines all concepts used throughout the perception system
 * with modern C++20/23 features including requires clauses, concepts composition,
...
/**
 * @brief Concept for numeric types with modern C++20 features
 */
template<typename T>
...
/**
 * @brief Modern concept for async operations with C++20 features
 */
template<typename T>
